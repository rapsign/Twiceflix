...
function WatchContent() {
  ...
  useEffect(() => {
    ...
    // Coba youtube_video dulu, kalau gagal fallback ke youtube_short
    fetchVideo(videoId)
      .then((data) => {
  ...
  useEffect(() => {
    ...
    const shuffled = [...allVideos]
      .filter((v) => !v.is_short) // pastikan hanya video biasa
